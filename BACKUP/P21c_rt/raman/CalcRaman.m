...
Spectra = figure('Position', get(0, 'Screensize') * 0.7);
...
expdata = load("/home/jrjturnbull/SummerProject/PROJECT/exp/10Kd2_48.1gpa.dat");
...
legend(strcat(Spacegroup, ' C||Z backscatter'), strcat(Spacegroup, ' Isotropic'), strcat(Spacegroup, ' 48.1GPa (experimental)'))
